<%@page session="true" %><c:forEach items='${data.keySet()}' var="aprop">
	<label class="${c1name}"><a data-title="${ontoBean.getEscapedValue('label',locale,aprop.getPropertyUrl())}"  data-description="${ontoBean.getEscapedValue('comment',locale,aprop.getPropertyUrl())}" href="${aprop.getPropertyUrl()}"><c:choose>
